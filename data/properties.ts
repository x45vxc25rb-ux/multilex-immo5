...
export interface Property {
  /** Уникальный идентификатор, например "villa-am-see" — используется в URL /immobilien/[id] */
  id: string;
  ...
  description?: string;
  /** Дополнительные характеристики объекта (Baujahr, Heizung и т.д.) — показываются на странице объекта */
  facts?: PropertyFact[];
...
export const properties: Property[] = [
  {
    ...
    area: 291,
    facts: [
      { label: "Baujahr", value: "1993" },
      { label: "Wohneinheiten", value: "8" },
      { label: "Wohnfläche", value: "291 m²" },
      { label: "Vollgeschosse", value: "3" },
      { label: "Keller", value: "vollunterkellert" },
      { label: "Heizung", value: "Ölheizung, zentral" },
      { label: "Lage", value: "Bayerisch Gmain / Bad Reichenhall" },
      { label: "Energieausweis", value: "liegt nicht vor" },
    ],
    description:
